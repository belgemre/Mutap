...
<div class="container ana">
	...
	<div class="col-md-10 col-md-offset-1 well" >
        ...
        <div class="wizard">
			...
			<form role="form" method="post" id="personelekle" action="" onsubmit="return false;" >
                <div class="tab-content">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label >Adı:</label>
									<input type="text" name="adi" id="adi" required class="form-control" placeholder="Personelin Adı">
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
							  <div class="form-group">
								<label >Soyadı:</label>
								<input type="text" name="soyadi" required class="form-control" placeholder="Personelin Soyadı">
							  </div>
							</div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
						<div class="row">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label >Çalışacağı Pozisyon:</label>
									<select  name="konum" id="konum" class="form-control roller" required >
											...
											?>
											<option value="<?php echo $row['rol_id']; ?>"><?php echo $row['konum']; ?></option>
											<?php } ?>
